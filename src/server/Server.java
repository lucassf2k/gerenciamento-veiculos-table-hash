...
import server.db.outsideaddressing.TableHashOutsideAddressing;
import server.db.openaddressing.TableHashOpenAddressing;
...
public class Server {
    ...
    private TableHash<Vehicle, NodeOutsideAddressing> db;  

    
    public Server(int option) {
        if (option == 1) {
            this.db = new TableHashOutsideAddressing(62);
        } else {
            this.db = new TableHashOpenAddressing(62);
        }
    ...
    public void remove(long renavam) {
    ...
    public NodeOutsideAddressing getOne(long renavam) {
        return this.db.search(renavam);
    }

    public boolean update(long renavam, Vehicle v) {
        this.db.update(renavam, v);
        return true;
    } 

    public NodeOutsideAddressing getByLicensePlate(String licensePlate) {
