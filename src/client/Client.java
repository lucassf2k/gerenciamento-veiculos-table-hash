...
public class Client {
    ...
    public Client(int option) {
        this.protocol = new Protocol(option);
    }
    ...
    private void getOne() {
        ...
        if (vehicle == null) {
            ...
            System.out.println(
                " Placa: " + vehicle.getVehicle().getLicencePlate() + 
                "; Modelo: " + vehicle.getVehicle().getName() + 
                "; Renavam: " + vehicle.getVehicle().getRenavam() + 
                "; Data de fabricação: " + vehicle.getVehicle().getManufacturingDate() + 
                "; Nome do condutor: " + vehicle.getVehicle().getDriver().getName() + 
                "; CPF do condutor " + vehicle.getVehicle().getDriver().getCpf()
            );
        }
    }
